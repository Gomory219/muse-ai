package cn.edu.sxu.museai.graph.tools;

import cn.edu.sxu.museai.graph.model.ImageCategoryEnum;
...
public class UndrawIllustrationTool {
    ...
    private static final String UNDRAW_API_URL = "https://undraw.co/_next/data/rxbI0cNBbVhP70ybALHAo/search/%s.json";
